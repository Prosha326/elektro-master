  ...
  head: () => ({
    meta: [
      { title: "Михаил Беспалов — Электромонтаж, ОПС, видеонаблюдение, сети связи" },
      {
        name: "description",
        content:
          "Частный мастер по электромонтажу и слаботочным системам. Установка розеток, замена проводки, щитки, видеонаблюдение, пожарная сигнализация. Работа по нормам, с гарантией.",
      },
      {
        name: "keywords",
        content:
          "электромонтаж, электрик, замена проводки, щиток, видеонаблюдение, пожарная сигнализация, Славянск-на-Кубани",
      },
      { property: "og:title", content: "Михаил Беспалов — Электромонтаж и слаботочные системы" },
      {
        property: "og:description",
        content: "Электромонтаж, ОПС, видеонаблюдение, сети связи. По нормам, с гарантией.",
      },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
        <img
          src={hero}
          alt="Современный интерьер с электромонтажом"
          width={1920}
          height={1280}
          fetchPriority="high"
      ...
      <section className="py-14 sm:py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
            <img
              src={about}
              alt="Михаил Беспалов — частный мастер по электромонтажу"
              width={800}
              height={800}
              loading="lazy"
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Частный мастер по электромонтажу и слаботочке
              </p>
              ...
              <p className="mt-5 sm:mt-6 text-foreground/80 leading-relaxed">
                ...
                Электромонтаж в домах, квартирах и коммерческих объектах — по нормам, с понятным
                результатом и ответственностью за работу.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-10 sm:mt-12">
            {services.map((s) => (
              <article
                key={s.id}
                className="bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition"
              >
                {s.image_url && (
                  <img
                    src={s.image_url}
      ...
      <section className="py-14 sm:py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mt-3">
            Чтобы цена и сроки были прозрачны
          </p>
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mt-10 sm:mt-12">
            <div className="bg-card rounded-2xl p-6 shadow-sm">
              <ul className="space-y-3">
                {[
                  "Согласовываю объём работ до старта",
                  "Оцениваю на месте (кроме мелких задач)",
                  "Работаю на безопасность и качество",
                ].map((t) => (
            ...
            <div className="bg-card rounded-2xl p-6 shadow-sm">
              <ul className="space-y-3">
                {[
                  "Работа «наспех и без расчёта»",
                  "Работы без понимания объёма",
                  "Начало работ без согласования",
                ].map((t) => (
                  <li key={t} className="flex gap-3">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 sm:mt-10 bg-card rounded-2xl shadow-sm overflow-hidden">
            {prices.map((p, i) => (
              <div
                key={p.id}
                className={`flex justify-between items-center gap-4 p-4 sm:p-5 ${i !== prices.length - 1 ? "border-b border-border" : ""}`}
              >
      ...
      <section id="contact" className="py-14 sm:py-20 px-4 bg-secondary/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 mt-10 sm:mt-12">
            <div>
              <a
                href="tel:+79183507782"
                className="flex items-center gap-3 text-xl sm:text-2xl font-bold text-primary hover:opacity-80"
              >
      ...
      <footer className="py-8 px-4 text-center text-sm text-muted-foreground border-t border-border space-y-2">
        ...
        <Link to="/login" className="inline-block text-xs opacity-50 hover:opacity-100">
